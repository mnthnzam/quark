...
1. (2026-09-21) Never edit the Figma sections "Home Page" and "Quark Xpress Product" — they are captures of the live site. Clone from them into the release-shells section.
2. (2026-09-21) Never change quark.com from a session. Site changes are proposed in `audit/site-audit.csv` and made by Vinodh.
3. (2026-09-21) Never open the outbound spam URLs found on quark.com/academic. They are logged in the audit as a security finding, not as links to visit.
4. (2026-09-21) Files in `sources/` are never edited after they land. Corrections go in a new dated file beside them.
5. (2026-09-21) Nothing from this repo is cited in CISCO work, and nothing from CISCO is cited here.
